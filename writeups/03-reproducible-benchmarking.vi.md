...
### Phương pháp bảo chứng cho mọi con số trong repo này
...
1. **Đo trước và sau, lần nào cũng vậy.** Tôi báo mọi thay đổi so với một baseline đã ghi
...
Trong cả hai dự án, tôi báo mọi tối ưu hóa so với một baseline như vậy. Nhờ đó một câu như
...
chỉ qua gate nếu chất lượng đã đo giữ nguyên hoặc tốt hơn trên các trường hợp cố định đó. Một
...
thì tôi không ghi lại như một phát hiện.

## 5. Chọn thước đo chất lượng có thể thay đổi
...
Kế hoạch ban đầu là báo tỷ lệ compile thành công. Code sinh ra có build được không? Con số
...
Thước đo thay thế đếm những gì thực sự thay đổi. Đó là lượng logic sinh ra vượt qua gate compile
...
## 7. Giá trị chứng minh của thứ tự commit
...
tôi chuẩn bị repository để phát hành, nên người đọc không thấy những tuần trước đó. Điều người
