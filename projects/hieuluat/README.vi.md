...
> được. Hệ thống viện dẫn nguồn. Khi kho văn bản không có câu trả lời, hệ thống nói thẳng là
> không đủ căn cứ, thay vì phỏng đoán. HieuLuat là sản phẩm thương mại đang chuyển giao quyền sở hữu, nên code, kho văn bản
> và prompt của nó tôi vẫn giữ riêng. Trang này trình bày kiến trúc, lập luận đằng sau thiết
...
- **Trạng thái:** sản phẩm đã phát hành, code giữ riêng. Tôi xây và đo xong trước đợt
  đánh giá tháng 8 năm 2026 mà writeup nêu, và chưa chạy lại từ đó.
...
- **Cam kết:** mọi câu trả lời đều lấy từ văn bản luật mà bước retrieval trả về, và đều có trích dẫn. Hệ thống có sẵn một nhánh cho trường hợp "không tìm thấy thông tin"
- **Cổng chất lượng:** các eval set đã gán nhãn quyết định giữ hay bỏ một tối ưu hóa

## Phạm vi công bố

Code, kho văn bản luật, prompt, cấu hình và dữ liệu đánh giá vẫn nằm trong repo riêng. Trang này có pipeline
kèm ranh giới từng giai đoạn, các quyết định tôi đã chọn và lý do, cùng những con số retrieval đúng
như harness của sản phẩm báo cáo, kể cả con số cho kết quả âm. Mỗi con số ghi kèm ngày đo và
...
Nên tiêu chuẩn không nằm ở chỗ nghe có vẻ đúng. Mọi nhận định đều phải truy nguyên về một điều khoản có
thật, và khi kho văn bản im lặng thì hệ thống phải tuyên bố rõ. Ràng buộc đó có trước, rồi quy trình mới dựng
quanh nó.

## Quy trình bảy giai đoạn
...
**Bám nguồn nằm trong thiết kế, không phải bộ lọc gắn thêm.** Yêu cầu trích dẫn và nhánh không có thông tin là
đặc tính của chính giai đoạn trả lời. Chúng không phải một bộ lọc gắn thêm sau khi sinh câu trả lời.
Tôi dựng hệ thống sao cho một câu trả lời không bám nguồn rất khó xuất hiện.
...
lượng đo trên các trường hợp cố định, không theo cảm tính. Chính các eval set đó quyết định giữ
hay bỏ một tối ưu hóa.
...
Mục 6 của writeup đó đáng đọc. Hóa ra reranker tốn thêm 384 ms mà không cải thiện được gì.
Phần việc có ích là tìm ra kết quả đó nói về thành phần nào.
...
Khi một con số chất lượng đứng yên, hãy nghi ngờ eval set trước khi tin kết quả. Và
